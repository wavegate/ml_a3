...
print(f"K-means Clustering Results with {n_clusters} clusters:")
...
print("Cluster Characteristics after K-means Clustering:")
print(cluster_summary)
print("\nCluster Sizes after K-means Clustering:")
print(cluster_sizes)