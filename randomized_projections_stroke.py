...
# Selecting features for projection (all except 'stroke')
...
X_projected_best = grp_best.fit_transform(X)
...
sns.scatterplot(x=X_projected_best[:, 0], y=X_projected_best[:, 1], hue=df['stroke'], palette='Set1', legend='full', alpha=0.7)
sns.scatterplot(x=X_noisy_projected_best[:, 0], y=X_noisy_projected_best[:, 1], hue=df['stroke'], palette='Set1', legend='full', marker='x', alpha=0.7)
...
plt.figure(figsize=(10, 6))
sns.scatterplot(x=X_projected_best[:, 0], y=X_projected_best[:, 1], hue=df['stroke'], palette='Set1', legend='full')
